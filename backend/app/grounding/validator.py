...
class GeminiGroundingJudge:
    ...
    def _judge_sync(
        ...
        prompt = (
            ...
            '{"decisions": [{"citation_index": 1, "supported": true, "reason": "..."}]}'
        )
        ...
        resp = httpx.post(
            f"https://generativelanguage.googleapis.com/v1beta/models/{settings.gemini_grounding_model}:generateContent?key={settings.gemini_api_key}",
            json={
        ...
        parsed = CitationGroundingDecisionList(**parsed_json)
